...
public final class GetUserGames extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      gameOverviews = support.CollectGameOverviewData.getGameOverview(userID);
    } catch (Exception e) {
    ...
    RequestDispatcher dispatch = request.getRequestDispatcher("pickGame.jsp");
