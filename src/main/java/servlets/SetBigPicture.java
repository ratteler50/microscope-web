 ...
 */
public class SetBigPicture extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request,
    ...
    if (!Settings.DEBUG) {
      ...
      if (CPA[0] != -1) {
        System.err.println("Something is wrong. "
            + "It should not be anyone's turn");
    ...
    String bigPicutreText = request.getParameter("bigPicture");

    try {
      gameBigPictureAdd(gameID, bigPicutreText);
      gameNextTurn(gameID);
