...
public class DatabaseReads {
  ...
  /**********************************************************
   * The following functions are mostly used for a given player to see info
   * about the games they are currently in
   *
   **********************************************************/
  /**
  ...
  /**********************************************************
   * The following functions are mostly used to populate a new connection with
  ...
  public static CachedRowSet getEvents(int gameID) throws DbException {
    ...
    try {
      ...
      // Create the statement
      String getevents = "SELECT EVENTS.* FROM EVENTS, PERIODS "
          + "WHERE game = ? AND EVENTS.period = PERIODS.id";
  ...
  public static CachedRowSet getScenes(int gameID) throws DbException {
    ...
    try {
      ...
      // Create the statement
      String getscenes = "SELECT SCENES.* FROM SCENES, EVENTS, PERIODS"
  ...
  public static CachedRowSet getCharacters(int gameID) throws DbException {
    ...
    try {
      ...
      // Create the statement
      String getcharacters = "SELECT * FROM "
          ...
          + "EVENTS.period = PERIODS.id AND " + "PERIODS.game = ?";
  ...
  public static CachedRowSet getPlayers(int gameID) throws DbException {
    try {
      ...
      // Create the statement
      String getplayers = "SELECT PLAYERS.*, USERS.user_name "
          + "FROM PLAYERS, USERS "
   ...
   */
  public static CachedRowSet getLegacies(int gameID, int round)
      throws DbException {
    try {
      Connection conn = connect();
  ...
  public static CachedRowSet getInScene(int gameID) throws DbException {
    try {
      ...
      // Create the statement
      String getInScene = "SELECT role, scene, players.position "
  ...
  public static boolean actionAllDoneCheck(int gameID) throws DbException {
    ...
    try {
      ...
      String doneCount = "SELECT COUNT(*) FROM PLAYERS WHERE game = ? "
          + "AND action_done = FALSE";
  ...
  public static boolean actionDoneCheck(int userID, int gameID) {
    ...
    try {
      ...
      String actionDoneCheck = "SELECT action_done FROM PLAYERS " +
  ...
  public static boolean paletteLegalCheck(int userID, int gameID) {
    ...
    try {
      ...
      String minCheck = "SELECT COUNT(*) FROM PLAYERS WHERE game = ? "
  ...
  public static int getSceneStepsLeft(int sceneID) {
    ...
    try {
      ...
      // Create the statement
      String getscenes = "SELECT steps_left FROM SCENES"
          + " WHERE id = ?";
      PreparedStatement pStmt = conn.prepareStatement(getscenes);
