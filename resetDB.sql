...
INSERT INTO periods (period, description, tone, "position", turn, round, game, player) VALUES
  ('THE THICKENING: KHALIDOR STARTS EMITTING AN ATMOSPHERE THAT SHROUDS THE NEAREST MOONS', '', 0, 4, 0, 11, 2, 1);
INSERT INTO periods (period, description, tone, "position", turn, round, game, player)
VALUES ('THE WAR OF WEALTH: COLD WAR BETWEEN THE CMA AND THE COM', '', 1, 5, 0, 11, 2, 1);
INSERT INTO periods (period, description, tone, "position", turn, round, game, player) VALUES
  ('THE ERA OF SUCCESSFUL EXPERIMENTS: SEVERAL ENTIRELY NEW TECHNIQUES OF MAGIC ARE DEVELOPED', '', 0, 6, 0, 11, 2,
   1);
INSERT INTO periods (period, description, tone, "position", turn, round, game, player)
...
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES (
  ...
  '', 1, 1, 0, 11, 7, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES
  ('THE FOUNDING OF THE ORDER OF THE GODS, A SECRET ORGINIZATION BASED ON VESUVIUS.  GODS ARE PEOPLE', '', 0, 2, 0,
   11, 7, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player)
...
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES (
  ...
  '', 0, 7, 0, 11, 7, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES
  ('THE VESUVIAN GOD ORLACH ATTEMPTS TO EXTEND THE THICKENING TO VESUVIUS BUT IS FOILED BY UNKNOWN FORCES', '', 1, 1,
   0, 11, 8, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player)
VALUES ('OKARIAN MECHANICS INVENT NEW METHODS OF TRAVEL IN THE THICKENING - OPEN AIR SHIPS', '', 0, 2, 0, 11, 8, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES
  ('HEPHAESTUS DUE TO EXTREME HEAT BECOMES THE MOST PROSPEROUS MOON FROM TRADE, ASSISTED BY THE THICKENING', '', 0,
   3, 0, 11, 8, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player)
...
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES
  ('TITANIA, PART OF COM IS NOW IN THE THICKENING.  THEY ARE KICKED FROM COM AND DISALLOWED IN CMA', '', 1, 7, 0, 11,
   8, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES
  ('BOTH THE CMA AND COM BYLAWS MUST BE REWRITTEN WHEN THE THICKENING SUDDENLY DISAPPEARS', '', 1, 8, 0, 11, 8, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player)
...
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES (
  ...
  '', 1, 5, 0, 11, 10, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES
  ('THE SOURCE OF ALL KNOWN FORMS OF MAGIC IS DISCOVERED TO FLOW FROM KHALIDOR ITSELF', '', 0, 6, 0, 11, 10, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES
  ('OKARIAN MECHANICS CREATE CRYSTAL FORTRESS THAT INCREASES CORE WORLD DEFENSES IN THE THICKENING', '', 0, 7, 0,
   11, 10, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player)
...
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES
  ('THE GODS DECIDE TO ADD MORE GODS FROM THE GODLINGS, AND THE GODLINGS DISPUTE ESCALATES TO WAR', '', 1, 1, 0, 11,
   11, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES
...
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES (
  ...
  '', 0, 3, 0, 11, 11, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES
  ('KYLAR, GOD OF PESTILENCE, TAMPERS WITH TITANIAN RITUAL TO CAUSE DEVESTATING DISEASE', '', 1, 4, 0, 11, 11, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES (
...
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES
  ('PRISONERS ON VESUVIUS MAKE A CULT TO THE FOUR HORSEMEN AND SOME BECOME PATHOMANCERS PROLONGING THEIR LIFE', '',
   1, 1, 0, 11, 12, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player)
VALUES ('THE DIVINE VESSELS AND THEIR FOLLOWERS BRING ABOUT THE DEATH OF REEK VII', '', 0, 2, 0, 11, 12, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player) VALUES
  ('LUNAR ALLIANCE MANDATES DECIMATION OF COMMUNITY TRIBES IN ORDER TO CURB THEIR POWER', '', 1, 1, 0, 11, 13, 1);
INSERT INTO events (event, description, tone, "position", turn, round, period, player)
